...
class TestTDMLoader(TestCase):
    ...
    def test_get_channel_by_index(self):
        ...
        self.assertTrue((self.data.channel(0, "Integer32_with_max_min") == s.array([9, 10, 11, -50, sys.maxint, -sys.maxint - 1])).all())
        self.assertTrue((self.data.channel("channel2", 0) == s.array([1.7976931348623157e+308, sys.maxint])).all())
        self.assertTrue((self.data.channel("channel2", 1) == s.array([0])).all())
        self.assertTrue((self.data.channel("channel2", "") == s.array([1.7976931348623157e+308, sys.maxint])).all())
    ...
    def test_get_item(self):
        ...
        self.assertTrue((self.data[1, 0] == s.array([1.7976931348623157e+308, sys.maxint])).all())
        ...
        self.assertTrue((self.data[''] == s.array([0])).all())
        self.assertTrue((self.data['Integer32_with_max_min'] == s.array(
            [9, 10, 11, -50, sys.maxint, -sys.maxint - 1])).all())
