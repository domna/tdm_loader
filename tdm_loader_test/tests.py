...
class TestTDMLoader(TestCase):
    ...
    def test_col(self):
        ...
        self.assertTrue((self.data.col(2) == s.array([9, 10, 11, -50, 2147483647, -2147483648,])).all())
        self.assertTrue((self.data.col(3) == s.array([1.7976931348623157e+308, 2147483647])).all())
